                ...
                <div className="navbar-search navbar-search-none">
                  <Form className="d-flex">
                    <Form.Control
                      ...
                      className="me-2"
                      aria-label="Search"
                      style={{ color: "#008dff",position:"relative"}}
                      value={value}
                      onChange={(e)=>setValue(e.target.value)}
                    />

                    {value?.length>0? <div className="search-result">
                      <div className="product-limit-container">
                            <span>{t('searchLang.search1')}({products.length})</span>
                            <a href="#">{t('searchLang.search2')} <MdNavigateNext style={{fontSize:"16px"}}/> </a>
                      </div>
                        ...
                        <Link to={`/product/${item.id}`} style={{textDecoration:"none",color:"black"}}>
                          <div className="search-items-container">
                            <div className="search-items-left">
                              <img src={item.thumbnail} alt="search-item-thumbnail" />
                              <h6>{item.title}</h6>
                            </div>
...
{/*//////////////////////////////////////// Left Side bar Networks \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*/}
                  <div className="left-side-bar-network">
                    <a href="https://www.instagram.com/_khayrullayev_06/" target='blank' style={{cursor:"default"}}><BsInstagram className="left-side-bar-network-icon"/></a> 
                    <a href="https://t.me/Khayrullayev_06" target='blank' style={{cursor:"default"}}><BsTelegram className="left-side-bar-network-icon"/></a>
      ...
      <div className="navbar-search navbar-search-bottom">
        <Form className="d-flex">
          ...
          {value?.length>0? <div className="search-result">
              <div className="product-limit-container">
                    <span>{t('searchLang.search1')}({products.length})</span>
                    {/* <a href="#">Barcha mahsulotlarni ko'rish <MdNavigateNext style={{fontSize:"16px"}}/> </a> */}
              </div>
              {products.map((item,index)=>{
                return(
                <>
